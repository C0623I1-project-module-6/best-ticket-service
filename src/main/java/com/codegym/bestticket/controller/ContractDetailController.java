...
public class ContractDetailController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ResponseDto> getContractDetail(@PathVariable UUID id, @PathVariable UUID contractId) {
        Optional<ContractDetailResponseDTO> contractDetailResponseDTOOptional = contractDetailService.findById(id);
        if(contractDetailResponseDTOOptional.isPresent()) {
            ContractDetailResponseDTO contractDetailResponseDTO = contractDetailResponseDTOOptional.get();
            ResponseDto responseDto = ResponseDto.builder()
